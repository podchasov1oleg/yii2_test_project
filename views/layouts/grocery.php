...
<div class="agileits_header">
    ...
    <div class="product_list_header">
        <button type="button" class="button js-modal-sum" data-toggle="modal" data-target="#modal-basket" onclick="getCart()">
            $<?= \Yii::$app->session->get('cart.sum') ?? '0' ?>
        </button>
        <div class="modal fade" id="modal-basket" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
